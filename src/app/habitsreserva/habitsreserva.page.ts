...
export class HabitsreservaPage implements OnInit {
  ...
  constructor(private hotelService: HotelService, private route: ActivatedRoute, private location: Location, private router: Router) {}
  ...
  navegarAResumen() {
    this.router.navigate(['/selccresm'], { queryParams: { habitaciones: JSON.stringify(this.habitacionesSeleccionadas), fechaInicio: JSON.stringify(this.fechaInicioRango), fechaFin: JSON.stringify(this.fechaFinRango) } });
  }
}
